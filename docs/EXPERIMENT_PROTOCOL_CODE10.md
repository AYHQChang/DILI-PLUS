...
状态：**已预注册；legacy pilot、确定性双重重建、正式 split、Table 1、Code-09 合同、
六模型单种子五折主运行、128/8 架构敏感性、三种子稳定性、最低消融和 24/48/72 h
early-warning 性能均已通过。** Table 2 与 Figures 2--4 尚待按这些正式 manifests 重建；任何
与本协议不一致的历史 checkpoint、CSV、表格或图片均不能进入论文。
